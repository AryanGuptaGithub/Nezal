...
export default function AddConcernPage() {
  ...
  <div className="bg-muted/60 px-4 py-3 border-b">
    ...
    <p className="text-xs text-muted-foreground mt-0.5">
      Search and add products that address this concern
    </p>
  </div>
  ...
  <div className="p-4 h-[250px] flex flex-col">
    ...
    <div className="mt-3 flex-1 overflow-y-auto space-y-2 border-t pt-2 scroll-smooth">
      {selectedProducts.length > 0 &&
        selectedProducts.map((p) => (
          ...
          >
            ...
            >
              <X className="w-5 h-5 text-white rounded-xl p-1 bg-[#b20909]" />
            </button>
          </div>
        ))}
    </div>
